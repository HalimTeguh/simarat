...
<div class="container">
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-3">Detail Pengguna - Manajemen Persuratan</h3>
                <h6 class="op-7 mb-2">Halaman ini digunakan untuk menampilkan detail data pengguna</h6>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <div class="card-head-row card-tools-still-right">
                            ...
                            <div class="card-tools">
                                <a class="btn btn-primary btn-md" href="{{ route('users.edit', $user->id) }}">
