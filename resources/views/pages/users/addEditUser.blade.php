                                ...
                                <div class="col-md-12 col-lg-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('role') is-invalid @enderror" id="role"
                                            ...
                                            <option value="staff" {{ (isset($user) && $user->role == 'staff') ?
                                                'selected' : '' }}>Staff</option>
                                            <option value="viewer" {{ (isset($user) && $user->role == 'viewer') ?
...
function removeAvatar() {
    ...
    const status = document.getElementById('upload-status');
    const removeBtn = document.getElementById('remove-avatar');
    const hasExistingAvatar = '{{ isset($user) && $user->avatar ? "true" : "false" }}' === 'true';
    ...
    if (hasExistingAvatar) {
        ...
        preview.src = '{{ isset($user) && $user->avatar ? Storage::url($user->avatar) : "" }}';
        preview.classList.remove('d-none');
        placeholder.classList.add('d-none');
    } else {
